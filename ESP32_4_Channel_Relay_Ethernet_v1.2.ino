...
#define Channel3_Pin    12              // Define the Relay Control pin
#define Channel4_Pin    15             // Define the Relay Control pin
...
#define LEDPIN          14             // Define the LED Control pin
...
void setup() {
  ...
  StartNetwork();                         // Network connection
